...
- Add resource principle to interactive tools skill: lightweight gateway (minimal RAM/CPU) vs heavy workers that must wind down to zero instances
...
- Add critical rule to interactive tools skill: never hardcode computed data from ad-hoc calculations into source files. All chart/UI data must come from generation scripts that write data files.
...
- Trim redundancy and bloat from 10 technical-patterns skills, removing ~800 lines of duplicate content, restated summaries, and boilerplate sections
...
- Add test-writing skill and /write-tests command with Given-When-Then conventions, fixture extraction, and edge case coverage
...
- Fix datasets loading pattern: ensure_datasets() returns a dict, not the datasets submodule
...
[3.22.3]: https://github.com/PolicyEngine/policyengine-claude/compare/3.22.2...3.22.3
...
[3.18.0]: https://github.com/PolicyEngine/policyengine-claude/compare/3.17.1...3.18.0
[3.17.1]: https://github.com/PolicyEngine/policyengine-claude/compare/3.17.0...3.17.1
[3.17.0]: https://github.com/PolicyEngine/policyengine-claude/compare/3.16.1...3.17.0
[3.16.1]: https://github.com/PolicyEngine/policyengine-claude/compare/3.16.0...3.16.1
